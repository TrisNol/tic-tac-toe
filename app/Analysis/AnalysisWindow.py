...
class AnalysisWindow(QWidget):
    ...
    def build_layout(self):
        ...
        label_avg_game_len = QLabel(f"Average Game Length: {self.analysis.avg_game_len(frame)}")
        label_avg_turns = QLabel(f"Average amount of turns: {self.analysis.avg_turns(frame)}")
